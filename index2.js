      ...
      switch (key) {
        ...
        case "f":
          ...
          case "m":
            ...
            case "q":
              var c14 = new Audio("piano/c14.mp3")
              c14.play();
              break;

            case "w":
              var d14 = new Audio("piano/d14.mp3")
              d14.play();
              break;

            case "e":
            var f14 = new Audio("piano/f14.mp3")
            f14.play();
            break;

            case "r":
            var g14 = new Audio("piano/g14.mp3")
            g14.play();
            break;

            case "t":
            var a14 = new Audio("piano/a14.mp3")
            a14.play();
            break;

            case "y":
              var c15 = new Audio("piano/c15.mp3")
              c15.play();
              break;

            case "u":
              var d15 = new Audio("piano/d15.mp3")
              d15.play();
              break;

            case "i":
            var f15 = new Audio("piano/f15.mp3")
            f15.play();
            break;

            case "o":
            var g15 = new Audio("piano/g15.mp3")
            g15.play();
            break;


            case "p":
            var a15 = new Audio("piano/a15.mp3")
            a15.play();
            break;
